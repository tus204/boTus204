            ...
            <div class="learn">
                ...
                <div class="learn-left">
                    <div class="learn-video">
                        <iframe class="learn-videos" src="https://www.youtube.com/embed/<?=$lessons['video']?>" frameborder="0" allowfullscreen> </iframe>
                        <div class="content-lesson"><?=$lessons['description']?></div>
                    </div>
                </div>
